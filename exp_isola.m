...
title('Estimate surface', ...
    'FontName', 'TimesNewRoman' ,'FontSize', fontsize)
subplot(325);
imagesc(phi_hat_SpInPHASE.*qual.*mask);  axis off;
